...
|---|---|
| [Дашборд](https://serjnsk.github.io/trenergram/prototype/) | Лента важных событий в две колонки — «Требует действия» и «Что произошло» — и панель «Аккаунт»: цифры с трендами, очередь составления |
