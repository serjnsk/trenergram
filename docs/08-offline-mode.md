# 08 — Оффлайн-режим: что доступно без сети и объёмы данных
...
2. **Оценки объёмов проверяются на сэмпле EDB** (30 бесплатных GIF — реальные размеры файлов) в рамках спайка №1 из [07 — Технологический стек](07-tech-stack.md).
