...
- Медиа (GIF, видео) через PowerSync **не** синхронизируется — только структурированные данные; загрузкой медиа управляет отдельный кэш-слой по правилам из [06 — Оффлайн-режим](06-offline-mode.md).
